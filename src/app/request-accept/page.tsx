...
const page = () => {
  return (
    <div className="flex flex-col h-full justify-between pb-5">
      ...
      <div className="px-4 bg-gray-g1-5 py-5 flex flex-col rounded-[12px]">
        <div className="flex flex-col gap-10">
          <div className="text-center border border-main px-4 py-3 rounded-[12px] bg-white w-[85%] mx-auto">
          ...
          <div className="flex flex-col gap-3 px-4 bg-white rounded-[12px] py-5">
